...
async function extractCertificate(req) {
    return new Promise (async (resolve, reject) => {
        ...
        try {
            ...
            } else if (req.headers['content-type'] == 'application/x-www-form-urlencoded' || req.headers['content-type'] == "application/json") {
                certificates = await fetchCertificatesByUri(req)
            }
...
async function fetchCertificatesByUri(req) {
